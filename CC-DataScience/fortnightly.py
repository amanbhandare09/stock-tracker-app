...
FORTNIGHTLY_DIRECTORY_PATH = os.getenv('FORTNIGHTLY_DIRECTORY_PATH')
FORTNIGHTLY_OUTPUT_PATH = os.getenv('FORTNIGHTLY_OUTPUT_PATH')
...
directory_path = FORTNIGHTLY_DIRECTORY_PATH
output_file_path = FORTNIGHTLY_OUTPUT_PATH
